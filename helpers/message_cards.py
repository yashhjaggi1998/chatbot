...
def create_ai_message_card(content: str):
        ...
        st.markdown(body = f"""
            <div class="message-wrapper ai">
                <div class="avatar ai-avatar">
                    <svg viewBox="0 0 24 24" aria-hidden="true" focusable="false" xmlns="http://www.w3.org/2000/svg" color="inherit" class="e14lo1l1 st-emotion-cache-1b2ybts ex0cdmw0">
...
def stream_static_string(text: str):
    accumulated_text = ""
    words = text.split(' ')
    ...
    with st.empty():
        for word in words:
            ...
            create_ai_message_card(accumulated_text.strip())
            time.sleep(0.2)
